...
class WeatherCubit extends HydratedCubit<WeatherState> {
  ...
  void toggleUnits() {
    final units = state.temperatureUnits.isFahrenheit ? TemperatureUnits.celcius : TemperatureUnits.fahrenheit;
    ...
    if(weather != Weather.empty) {
      ...
      final value = units.isCelsius ? temperature.value.toCelcius() : temperature.value.toFahrenheit();
